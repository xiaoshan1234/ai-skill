...
> **Umbrella note:** The narrow skills `codebase-inspection` and `hermes-agent-skill-authoring` have been archived and absorbed into this skill's class-level documentation. Their packages are preserved at `~/.hermes/skills/.archive/codebase-inspection/` and `~/.hermes/skills/.archive/hermes-agent-skill-authoring/`.
