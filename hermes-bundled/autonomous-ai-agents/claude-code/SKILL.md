---
name: claude-code
description: "Delegate coding to Claude Code CLI (features, PRs). Also covers OpenAI Codex and OpenCode as provider alternatives."
version: 2.2.0
...
metadata:
  hermes:
    tags: [Coding-Agent, Claude, Anthropic, Code-Review, Refactoring, PTY, Automation, Codex, OpenCode]
